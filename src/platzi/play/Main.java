...
public class Main {
    ...
    private static void cargarPeliculas(Plataforma plataforma) {
        ...
        plataforma.agregar(new Pelicula("El Señor de los Anillos", 201, "Fantasía", 4.9));
        plataforma.agregar(new Pelicula("Inception", 148, "Ciencia Ficción", 4.8));
        plataforma.agregar(new Pelicula("Toy Story", 81, "Animada", 4.7));
        plataforma.agregar(new Pelicula("Gladiador", 155, "Acción", 4.6));
        plataforma.agregar(new Pelicula("Titanic", 195, "Drama/Romance", 4.3));
        plataforma.agregar(new Pelicula("Matrix", 136, "Ciencia Ficción", 4.9));
        plataforma.agregar(new Pelicula("Coco", 105, "Animada", 4.8));
        plataforma.agregar(new Pelicula("Interestelar", 169, "Ciencia Ficción", 5));
